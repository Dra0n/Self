...
mongoose.connect("mongodb+srv://abdallax1x11234:aUt3GWI6XbDPl30B@cluster0.0w56z.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0");
...
نسعى الى خدمتكم بشكل افضل ⭐️ **`)
 .setColor("f1c40f")
               .setThumbnail(message.guild.iconURL({dynamic : true})).setTitle('SelfBot Services')],
      components: [row]
    });
  }
});
...
`)]});
member.send({embeds: [new MessageEmbed().setTitle("Na7la Host").setDescription(`تم الاشتراك في خدمة : تلفيل كتابي`)]})
...
تم الشراء من قبل : ${member}
`)]});
member.send({embeds: [new MessageEmbed().setTitle("Na7la Host ").setDescription(`تم الاشتراك في خدمة : تلفيل صوتي`)]})
              const bart = new MessageButton()
        .setLabel('قفل')
        .setCustomId('closeart')
        .setStyle('DANGER')
...
تم الشراء من قبل : ${member}
`)]});
member.send({embeds: [new MessageEmbed().setTitle("Na7la Host").setDescription(`تم الاشتراك في خدمة : اوتو رياكشن`)]});
      const bart = new MessageButton()
        .setLabel('قفل')
        .setCustomId('closeart')
        .setStyle('DANGER')
...
تم الشراء من قبل : ${member}
`)]});
member.send({embeds: [new MessageEmbed().setTitle("Na7la Host").setDescription(`تم الاشتراك في خدمة : حساب اونلاين`)]});
      const bart = new MessageButton()
        .setLabel('قفل')
        .setCustomId('closeart')
        .setStyle('DANGER')
